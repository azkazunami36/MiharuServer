...
const allowed: { [type: string]: string[] } = {
    files: ["", "index.html"],
    folders: ["home", ".well-known", "bulletinBoard", "donate", "novel", "promisedLazy", "request", "SW36", "WebOS", "games", "login", "createAccount", "src", "serverStatus", "accountManage", "jyuP", "medfom"]
};
